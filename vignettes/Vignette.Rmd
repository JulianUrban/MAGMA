...
### Balance Estimation
  ...
  This function is augmented by the function `Balance_extract`. This function extracts the balance criteria (`effects = FALSE`) or the pairwise effects (`effects = TRUE`) for a specific sample size per group (`samplesize`) from the results of `Balance_MAGMA`. If ordinal and nominal covariates should also be considered, they need to be specified using the arguments `covariates_ordinal` and `covariates_nominal`respectively. It returns a vector containing the balance criteria or the pairwise effects respectively.
